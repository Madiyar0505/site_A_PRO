...
export default function Person1Page() {
  const t = useTranslations('Person1');
    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50 py-16 px-4">
      <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-10 border border-[#fbbf24]">
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <p className="text-xl text-gray-600 mb-6">{t('fullname')}</p>
        </div>
        <div className="space-y-6 text-gray-700">
          ...
          <div className="flex items-center gap-2 justify-center">
            ...
            <a 
              href="https://orcid.org/0009-0004-7289-0943" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-blue-600 hover:text-blue-800 transition-colors"
            >
              https://orcid.org/0009-0004-7289-0943
            </a>
          </div>
          ...
          <div className="flex items-center gap-2 justify-center">
            ...
            <span>
              International Professional Master Coach/Business Trainer/Business & Executive Coach{' '}
              <a 
                href="https://www.coachunion.org/contacts.html#Kazakhstan" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-blue-600 hover:text-blue-800 transition-colors"
              >
